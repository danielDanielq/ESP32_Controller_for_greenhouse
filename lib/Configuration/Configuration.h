...
#define ENABLE_SERIAL_PRINT_DS18B20 0
#define ENABLE_SERIAL_PRINT_YFdn40 0
#define ENABLE_SERIAL_PRINT_SOIL 0
#define ENABLE_SERIAL_PRINT_SHT31 0
#define ENABLE_SERIAL_PRINT_TEMT6000 0
#define ENABLE_SERIAL_PRINT_MACARA 0

#define LUX_MAX 50000.0f // Lux max for TEMT6000 sensor
#define SAFETY_TIMEOUT 165000 // Timeout for cranes in milliseconds
